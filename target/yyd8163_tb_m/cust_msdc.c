...
{
    {
        ...
        MSDC_HIGHSPEED | MSDC_RST_PIN_EN | MSDC_DDR  | MSDC_HS200
#else
        MSDC_HIGHSPEED
#endif
    }
    ...
    ,
    {
		...
		MSDC50_CLKSRC4HCLK_26MHZ, /* host clock source		 */
		MSDC_SMPL_RISING,	/* command latch edge			 */
		MSDC_SMPL_RISING,	/* data latch edge				 */
		MSDC_DRVN_GEAR1,	/* clock pad driving			 */
		MSDC_DRVN_GEAR1,	/* command pad driving			 */
        ...
        /* hardware capability flags     */
#if defined(MMC_MSDC_DRV_CTP)
		MSDC_HIGHSPEED | MSDC_RST_PIN_EN | MSDC_DDR  | MSDC_HS200 | MSDC_HS400
#else
		MSDC_HIGHSPEED
#endif
    }
