...
void mt_gpio_set_power(void)
{
	...
	/* DPI 3.3v */
	/* Set  5E30[3:0]= 0101: 1.8v 0000 (default); 3.3v 0101*/
	GPIO_WR32(&pReg->bias_ctrl[1].set, 0x5 << 0);
	GPIO_WR32(&pReg->bias_ctrl[1].rst, 0xC << 0);

	/* NFI 3.3v */
	/* Set  5E20[15:12]= 0101: 1.8v 0000 (default); 3.3v 0101*/
	GPIO_WR32(&pReg->bias_ctrl[0].set, 0x5 << 12);
	GPIO_WR32(&pReg->bias_ctrl[0].rst, 0xC << 12);

	/* MSDC1 3.3v */
	/* Set  5E20[7:4]= 0101: 1.8v 0000 (default); 3.3v 0101*/
	GPIO_WR32(&pReg->bias_ctrl[0].set, 0x5 << 4);
	GPIO_WR32(&pReg->bias_ctrl[0].rst, 0xC << 4);

	/* MSDC2 3.3v */
	/* Set  5E20[3:0]= 0101: 1.8v 0000 (default); 3.3v 0101*/
	GPIO_WR32(&pReg->bias_ctrl[0].set, 0x5 << 0);
	GPIO_WR32(&pReg->bias_ctrl[0].rst, 0xC << 0);
