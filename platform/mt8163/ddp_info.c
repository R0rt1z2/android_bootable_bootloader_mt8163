...
int ddp_get_module_max_irq_bit(DISP_MODULE_ENUM module)
{
    switch(module)
    {
        ...
        case DISP_MODULE_DPI0   :    return 2;
...
int ddp_enable_module_clock(DISP_MODULE_ENUM module)
{
	switch(module)
	{
		...
		case DISP_MODULE_WDMA1:
			...
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG0_WDMA1,DISP_REG_CONFIG_MMSYS_DUMMY,0);
			break;
		case DISP_MODULE_DITHER:
		...
		case DISP_MODULE_DPI0:
			...
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_LVDS_PIX,DISP_REG_CONFIG_MMSYS_CG_CLR1,1);
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_LVDS_CTS,DISP_REG_CONFIG_MMSYS_CG_CLR1,1);
			break;
		default:
			DDPERR("enable module clock unknow module %d \n",module);
	}
	printf("enable	%s clk, CG0 0x%x, CG1 0x%x, dummy CON = 0x%x \n",
...
int ddp_disable_module_clock(DISP_MODULE_ENUM module)
{
	switch(module)
	{
		...
		case DISP_MODULE_WDMA1:
			...
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG0_WDMA1,DISP_REG_CONFIG_MMSYS_DUMMY,1);
			break;
		case DISP_MODULE_DITHER:
		...
		case DISP_MODULE_DPI0:
			...
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_LVDS_PIX,DISP_REG_CONFIG_MMSYS_CG_SET1,1);
			DISP_REG_SET_FIELD(NULL,MMSYS_CG_FLD_CG1_LVDS_CTS,DISP_REG_CONFIG_MMSYS_CG_SET1,1);
			break;
		default:
			DDPERR("enable module clock unknow module %d \n",module);

	}
	printf("disable %s clk, CG0 0x%x, CG1 0x%x,dummy CON = 0x%x\n",
			ddp_get_module_name(module), DISP_REG_GET(DISP_REG_CONFIG_MMSYS_CG_CON0),DISP_REG_GET(DISP_REG_CONFIG_MMSYS_CG_CON1),DISP_REG_GET(DISP_REG_CONFIG_MMSYS_DUMMY));
	return 0;
}
