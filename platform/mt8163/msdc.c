...
static struct msdc_reg_control hs400_backup_reg_list[HS400_BACKUP_REG_NUM] = {
  //{addr,                                         mask,                                value,     default value, func},
    {(MSDC3_BASE + OFFSET_MSDC_PATCH_BIT1),        (MSDC_PB1_WRDAT_CRCS_TA_CNTR),       0x0,       0x1,         NULL},//0xB4[2:0],
    {(MSDC3_BASE + OFFSET_MSDC_PATCH_BIT0),        (MSDC_PB0_INT_DAT_LATCH_CK_SEL),     0x0,       0x0,         NULL},//0xB0[9:7]
    {(MSDC3_BASE + OFFSET_MSDC_IOCON),             (MSDC_IOCON_R_D_SMPL),               0x0,       0x0,         NULL},//0x04[2:2]
    {(MSDC3_BASE + OFFSET_MSDC_PAD_TUNE),          (MSDC_PAD_TUNE_DATRRDLY),            0x0,       0x0,         NULL},//0xEC[12:8]
    {(MSDC3_BASE + OFFSET_MSDC_IOCON),             (MSDC_IOCON_DDLSEL),                 0x0,       0x0,         NULL},//0x04[3:3]
    {(MSDC3_BASE + OFFSET_MSDC_DAT_RDDLY0),        (MSDC_DAT_RDDLY0_D3),                0x0,       0x0,         NULL},//0xF0[4:0]
    {(MSDC3_BASE + OFFSET_MSDC_DAT_RDDLY0),        (MSDC_DAT_RDDLY0_D2),                0x0,       0x0,         NULL},//0xF0[12:8]
    {(MSDC3_BASE + OFFSET_MSDC_DAT_RDDLY0),        (MSDC_DAT_RDDLY0_D1),                0x0,       0x0,         NULL},//0xF0[20:16]
    {(MSDC3_BASE + OFFSET_MSDC_DAT_RDDLY0),        (MSDC_DAT_RDDLY0_D0),                0x0,       0x0,         NULL},//0xF0[28:24]
    {(MSDC3_BASE + OFFSET_MSDC_DAT_RDDLY1),        (MSDC_DAT_RDDLY1_D7),                0x0,       0x0,         NULL},//0xF4[4:0]
    {(MSDC3_BASE + OFFSET_MSDC_DAT_RDDLY1),        (MSDC_DAT_RDDLY1_D6),                0x0,       0x0,         NULL},//0xF4[12:8]
    {(MSDC3_BASE + OFFSET_MSDC_DAT_RDDLY1),        (MSDC_DAT_RDDLY1_D5),                0x0,       0x0,         NULL},//0xF4[20:16]
    {(MSDC3_BASE + OFFSET_MSDC_DAT_RDDLY1),        (MSDC_DAT_RDDLY1_D4),                0x0,       0x0,         NULL},//0xF4[28:24]
    {(MSDC3_BASE + OFFSET_MSDC_IOCON),             (MSDC_IOCON_R_D_SMPL_SEL),           0x0,       0x0,         NULL},//0x04[5:5]
    {(MSDC3_BASE + OFFSET_MSDC_IOCON),             (MSDC_IOCON_R_D0SPL),                0x0,       0x0,         NULL},//0x04[16:16]
    {(MSDC3_BASE + OFFSET_MSDC_IOCON),             (MSDC_IOCON_W_D_SMPL),               0x0,       0x0,         NULL},//0x04[8:8]
    {(MSDC3_BASE + OFFSET_MSDC_PAD_TUNE),          (MSDC_PAD_TUNE_DATWRDLY),            0x0,       0x0,         NULL},//0xEC[4:0]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT01_TUNE),  (MSDC_EMMC50_PAD_DAT0_RXDLY3SEL),    0x0,       0x0,         NULL},//0x190[0:0]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT01_TUNE),  (MSDC_EMMC50_PAD_DAT1_RXDLY3SEL),    0x0,       0x0,         NULL},//0x190[16:16]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT23_TUNE),  (MSDC_EMMC50_PAD_DAT2_RXDLY3SEL),    0x0,       0x0,         NULL},//0x194[0:0]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT23_TUNE),  (MSDC_EMMC50_PAD_DAT3_RXDLY3SEL),    0x0,       0x0,         NULL},//0x194[16:16]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT45_TUNE),  (MSDC_EMMC50_PAD_DAT4_RXDLY3SEL),    0x0,       0x0,         NULL},//0x198[0:0]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT45_TUNE),  (MSDC_EMMC50_PAD_DAT5_RXDLY3SEL),    0x0,       0x0,         NULL},//0x198[16:16]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT67_TUNE),  (MSDC_EMMC50_PAD_DAT6_RXDLY3SEL),    0x0,       0x0,         NULL},//0x19C[0:0]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT67_TUNE),  (MSDC_EMMC50_PAD_DAT7_RXDLY3SEL),    0x0,       0x0,         NULL},//0x19C[16:16]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT01_TUNE),  (MSDC_EMMC50_PAD_DAT0_RXDLY3),       0x0,       0x0,         NULL},//0x190[5:1]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT01_TUNE),  (MSDC_EMMC50_PAD_DAT1_RXDLY3),       0x0,       0x0,         NULL},//0x190[21:17]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT23_TUNE),  (MSDC_EMMC50_PAD_DAT2_RXDLY3),       0x0,       0x0,         NULL},//0x194[5:1]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT23_TUNE),  (MSDC_EMMC50_PAD_DAT3_RXDLY3),       0x0,       0x0,         NULL},//0x194[21:17]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT45_TUNE),  (MSDC_EMMC50_PAD_DAT4_RXDLY3),       0x0,       0x0,         NULL},//0x198[5:1]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT45_TUNE),  (MSDC_EMMC50_PAD_DAT5_RXDLY3),       0x0,       0x0,         NULL},//0x198[21:17]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT67_TUNE),  (MSDC_EMMC50_PAD_DAT6_RXDLY3),       0x0,       0x0,         NULL},//0x19C[5:1]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT67_TUNE),  (MSDC_EMMC50_PAD_DAT7_RXDLY3),       0x0,       0x0,         NULL},//0x19C[21:17]


    /* _HQA asked cmd line delay 8 and dat line delay 4 under hs400 mode */
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_CMD_TUNE),    (MSDC_EMMC50_PAD_CMD_TUNE_TXDLY),    0x0,       0x8,         NULL},//0x190[5:1]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT01_TUNE),  (MSDC_EMMC50_PAD_DAT0_TXDLY),        0x0,       0x4,         NULL},//0x190[5:1]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT01_TUNE),  (MSDC_EMMC50_PAD_DAT1_TXDLY),        0x0,       0x4,         NULL},//0x190[21:17]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT23_TUNE),  (MSDC_EMMC50_PAD_DAT2_TXDLY),        0x0,       0x4,         NULL},//0x194[5:1]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT23_TUNE),  (MSDC_EMMC50_PAD_DAT3_TXDLY),        0x0,       0x4,         NULL},//0x194[21:17]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT45_TUNE),  (MSDC_EMMC50_PAD_DAT4_TXDLY),        0x0,       0x4,         NULL},//0x198[5:1]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT45_TUNE),  (MSDC_EMMC50_PAD_DAT5_TXDLY),        0x0,       0x4,         NULL},//0x198[21:17]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT67_TUNE),  (MSDC_EMMC50_PAD_DAT6_TXDLY),        0x0,       0x4,         NULL},//0x19C[5:1]
    {(MSDC3_BASE + OFFSET_EMMC50_PAD_DAT67_TUNE),  (MSDC_EMMC50_PAD_DAT7_TXDLY),        0x0,       0x4,         NULL},//0x19C[21:17]
};
...
int msdc_register_partial_backup_and_reset(struct mmc_host* host)
{
    ...
    for(i = 0; i < HS400_BACKUP_REG_NUM; i++) {
        ...
        if(hs400_backup_reg_list[i].restore_func){
            ...
            if(err) {
                MSDC_ERR_PRINT(MSDC_ERROR,("[%s]: failed to restore reg[0x%x][0x%x], expected value[0x%x], actual value[0x%x] err=0x%x",
...
void msdc_clock(struct mmc_host *host, int on)
{
	...
	switch ( host->id) {
		case 3 :
			MSDC_SET_FIELD(TOPCKGEN_CTRL(CLKCFG4) ,MSDC_CKGENHCLK_PDN(MSDC3,CLKCFG4), (on ? 0 : 1)); 		
			MSDC_SET_FIELD(TOPCKGEN_CTRL(CLKCFG4), MSDC_CKGEN_PDN(MSDC3,CLKCFG4), (on ? 0 : 1));		
		    break;	
		case 2 : 
		...
		case 1 :
		   ...
		   break;
		case 0 :
		    MSDC_SET_FIELD(TOPCKGEN_CTRL(CLKCFG3), MSDC_CKGEN_PDN(MSDC0,CLKCFG3), (on ? 0 : 1));	  
		   break;
		default:
		   break;
	}
...
void msdc_config_clksrc(struct mmc_host *host, u32 clksrc, u32 hclksrc)
{
    ...
    if ( host->id == 3) {
	    if ( host->card && mmc_card_hs400(host->card)) {
	        ...
	        host->src_clk      = hclks_msdc50[MSDC50_CLKSRC_400MHZ];
		    ...
		    host->pll_mux_hclk = hclksrc;
	        host->src_clk      = hclks_msdc50[clksrc];
	    }
    }
	else {
		/* Perloader and LK use 200 is ok, no need change source */
...
#ifndef FPGA_PLATFORM
        if ( host->id == 3) {
			MSDC_SET_FIELD(TOPCKGEN_CTRL(CLKCFG4) ,MSDC_CKGENHCLK_SEL(MSDC3,CLKCFG4), hclksrc);		
			MSDC_SET_FIELD(TOPCKGEN_CTRL(CLKCFGUPDATE),MSDC_CKGENHCLK_UPDATE(MSDC3), 1);
			
			MSDC_SET_FIELD(TOPCKGEN_CTRL(CLKCFG4), MSDC_CKGEN_SEL(MSDC3,CLKCFG4), clksrc);		
		   ...
		   MSDC_SET_FIELD(TOPCKGEN_CTRL(CLKCFG3), MSDC_CKGEN_SEL(MSDC0,CLKCFG3), clksrc); 	  
...
int msdc_tune_rw_hs400(struct mmc_host *host, uchar *dst, ulong src, ulong nblks, unsigned int rw)
{
    ...
    MSDC_TRC_PRINT(MSDC_TUNING,("[tune][%s:%d] start hs400 read tune\n", __func__, __LINE__));
    ...
    do {
        ...
        do {
			...
			if (rw == 0){
				MSDC_DBG_PRINT(MSDC_TUNING,("[SD%d] <TUNE_BREAD_%d><%s><cmd%d:0x%x> ret=%d, DS_DLY1=%d, DS_DLY3=%d\n",
						host->id, times, result == MMC_ERR_NONE ? "PASS" : "FAIL", (nblks == 1 ? 17 : 18), (unsigned int)dst,
						result, ds_dly1, ds_dly3));
			} 
			else if (rw == 1){
				MSDC_DBG_PRINT(MSDC_TUNING,("[SD%d] <TUNE_BEWRITE_%d><%s><cmd%d:0x%x> ret=%d, DS_DLY1=%d, DS_DLY3=%d\n",
    ...
    if (rw == 0){
        MSDC_TRC_PRINT(MSDC_INFO,("[SD%d] <TUNE_BREAD_%d><%s><cmd%d> ret=%d @msdc_tune_rw_hs400\n",
                host->id, times, result == MMC_ERR_NONE ? "PASS" : "FAIL",
                (nblks == 1 ? 17 : 18),result));
    } 
	else if (rw == 1){
        MSDC_TRC_PRINT(MSDC_INFO,("[SD%d] <TUNE_BEWRITE_%d><%s><cmd%d> ret=%d@msdc_tune_rw_hs400\n",
                host->id, times, result == MMC_ERR_NONE ? "PASS" : "FAIL",
    ...
    switch (host->id) {
        case 0:
			...
			*/
			 ...
			 */
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_CLK(MSDC0)),	   BIT_GPIOMASK(PIN4_CLK(MSDC0)), 	        1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_CLK(MSDC0)), 	   BIT_GPIOMASK(PIN4_CLK(MSDC0)), 	        0);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_CLK(MSDC0)),	       BIT_MODE_GPIOMASK(PIN4_CLK(MSDC0)),      BV_GPIO_MSDC_MODE);

			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_CMD(MSDC0)),	   BIT_GPIOMASK(PIN4_CMD(MSDC0)), 	        1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_CMD(MSDC0)), 	   BIT_GPIOMASK(PIN4_CMD(MSDC0)), 	        1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_CMD(MSDC0)),	       BIT_MODE_GPIOMASK(PIN4_CMD(MSDC0)),      BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_RSTB(MSDC0)), 	   BIT_GPIOMASK(PIN4_RSTB(MSDC0)),	        1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_RSTB(MSDC0)),	   BIT_GPIOMASK(PIN4_RSTB(MSDC0)),	        1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_RSTB(MSDC0)),	       BIT_MODE_GPIOMASK(PIN4_RSTB(MSDC0)),     BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC0,DAT0)),  BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT0)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC0,DAT0)), BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT0)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC0,DAT0)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC0,DAT0)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC0,DAT1)),  BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT1)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC0,DAT1)), BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT1)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC0,DAT1)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC0,DAT1)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC0,DAT2)),  BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT2)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC0,DAT2)), BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT2)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC0,DAT2)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC0,DAT2)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC0,DAT3)),  BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT3)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC0,DAT3)), BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT3)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC0,DAT3)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC0,DAT3)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC0,DAT4)),  BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT4)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC0,DAT4)), BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT4)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC0,DAT4)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC0,DAT4)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC0,DAT5)),  BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT5)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC0,DAT5)), BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT5)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC0,DAT5)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC0,DAT5)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC0,DAT6)),  BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT6)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC0,DAT6)), BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT6)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC0,DAT6)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC0,DAT6)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC0,DAT7)),  BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT7)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC0,DAT7)), BIT_GPIOMASK(PIN4_DAT(MSDC0,DAT7)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC0,DAT7)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC0,DAT7)),	BV_GPIO_MSDC_MODE);
            break;
        case 1:
			/* msdc0 already init in preloader/LK. Therefore, the following code can be commented out. */
			/*
			...
			*/
			 ...
			 * set msdc mode. (MC0_DAT0~7, MC0_CMD, MC0_CLK, MC0_RST, MC0_DSL)
			 */
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_CLK(MSDC1)),	   BIT_GPIOMASK(PIN4_CLK(MSDC1)), 	        1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_CLK(MSDC1)), 	   BIT_GPIOMASK(PIN4_CLK(MSDC1)), 	        0);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_CLK(MSDC1)),	       BIT_MODE_GPIOMASK(PIN4_CLK(MSDC1)),      BV_GPIO_MSDC_MODE);
			

			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_CMD(MSDC1)),	   BIT_GPIOMASK(PIN4_CMD(MSDC1)), 	        1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_CMD(MSDC1)), 	   BIT_GPIOMASK(PIN4_CMD(MSDC1)), 	        1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_CMD(MSDC1)),	       BIT_MODE_GPIOMASK(PIN4_CMD(MSDC1)),      BV_GPIO_MSDC_MODE);

			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC1,DAT0)),  BIT_GPIOMASK(PIN4_DAT(MSDC1,DAT0)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC1,DAT0)), BIT_GPIOMASK(PIN4_DAT(MSDC1,DAT0)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC1,DAT0)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC1,DAT0)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC1,DAT1)),  BIT_GPIOMASK(PIN4_DAT(MSDC1,DAT1)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC1,DAT1)), BIT_GPIOMASK(PIN4_DAT(MSDC1,DAT1)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC1,DAT1)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC1,DAT1)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC1,DAT2)),  BIT_GPIOMASK(PIN4_DAT(MSDC1,DAT2)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC1,DAT2)), BIT_GPIOMASK(PIN4_DAT(MSDC1,DAT2)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC1,DAT2)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC1,DAT2)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC1,DAT3)),  BIT_GPIOMASK(PIN4_DAT(MSDC1,DAT3)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC1,DAT3)), BIT_GPIOMASK(PIN4_DAT(MSDC1,DAT3)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC1,DAT3)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC1,DAT3)),	BV_GPIO_MSDC_MODE);
            break;
        case 2:
			/* msdc0 already init in preloader/LK. Therefore, the following code can be commented out. */
			/*
			...
			*/
			 ...
			 * set msdc mode. (MC0_DAT0~7, MC0_CMD, MC0_CLK, MC0_RST, MC0_DSL)
			 */
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_CLK(MSDC2)),	   BIT_GPIOMASK(PIN4_CLK(MSDC2)), 	        1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_CLK(MSDC2)), 	   BIT_GPIOMASK(PIN4_CLK(MSDC2)), 	        0);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_CLK(MSDC2)),	       BIT_MODE_GPIOMASK(PIN4_CLK(MSDC2)),      BV_GPIO_MSDC_MODE);
			

			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_CMD(MSDC2)),	   BIT_GPIOMASK(PIN4_CMD(MSDC2)), 	        1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_CMD(MSDC2)), 	   BIT_GPIOMASK(PIN4_CMD(MSDC2)), 	        1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_CMD(MSDC2)),	       BIT_MODE_GPIOMASK(PIN4_CMD(MSDC2)),      BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC2,DAT0)),  BIT_GPIOMASK(PIN4_DAT(MSDC2,DAT0)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC2,DAT0)), BIT_GPIOMASK(PIN4_DAT(MSDC2,DAT0)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC2,DAT0)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC2,DAT0)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC2,DAT1)),  BIT_GPIOMASK(PIN4_DAT(MSDC2,DAT1)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC2,DAT1)), BIT_GPIOMASK(PIN4_DAT(MSDC2,DAT1)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC2,DAT1)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC2,DAT1)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC2,DAT2)),  BIT_GPIOMASK(PIN4_DAT(MSDC2,DAT2)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC2,DAT2)), BIT_GPIOMASK(PIN4_DAT(MSDC2,DAT2)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC2,DAT2)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC2,DAT2)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC2,DAT3)),  BIT_GPIOMASK(PIN4_DAT(MSDC2,DAT3)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC2,DAT3)), BIT_GPIOMASK(PIN4_DAT(MSDC2,DAT3)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC2,DAT3)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC2,DAT3)),	BV_GPIO_MSDC_MODE);
            break;
        case 3:
			/* msdc0 already init in preloader/LK. Therefore, the following code can be commented out. */
			/*
			...
			*/
			 ...
			 * set msdc mode. (MC0_DAT0~7, MC0_CMD, MC0_CLK, MC0_RST, MC0_DSL)
			 */
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_CLK(MSDC3)),	   BIT_GPIOMASK(PIN4_CLK(MSDC3)), 	        1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_CLK(MSDC3)), 	   BIT_GPIOMASK(PIN4_CLK(MSDC3)), 	        0);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_CLK(MSDC3)),	       BIT_MODE_GPIOMASK(PIN4_CLK(MSDC3)),      BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DSL(MSDC3)),	   BIT_GPIOMASK(PIN4_DSL(MSDC3)), 	        1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DSL(MSDC3)), 	   BIT_GPIOMASK(PIN4_DSL(MSDC3)), 	        1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DSL(MSDC3)),	       BIT_MODE_GPIOMASK(PIN4_DSL(MSDC3)),      BV_GPIO_MSDC_MODE);

			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_CMD(MSDC3)),	   BIT_GPIOMASK(PIN4_CMD(MSDC3)), 	        1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_CMD(MSDC3)), 	   BIT_GPIOMASK(PIN4_CMD(MSDC3)), 	        1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_CMD(MSDC3)),	       BIT_MODE_GPIOMASK(PIN4_CMD(MSDC3)),      BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_RSTB(MSDC3)), 	   BIT_GPIOMASK(PIN4_RSTB(MSDC3)),	        1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_RSTB(MSDC3)),	   BIT_GPIOMASK(PIN4_RSTB(MSDC3)),	        1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_RSTB(MSDC3)),	       BIT_MODE_GPIOMASK(PIN4_RSTB(MSDC3)),     BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC3,DAT0)),  BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT0)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC3,DAT0)), BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT0)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC3,DAT0)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC3,DAT0)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC3,DAT1)),  BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT1)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC3,DAT1)), BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT1)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC3,DAT1)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC3,DAT1)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC3,DAT2)),  BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT2)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC3,DAT2)), BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT2)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC3,DAT2)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC3,DAT2)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC3,DAT3)),  BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT3)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC3,DAT3)), BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT3)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC3,DAT3)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC3,DAT3)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC3,DAT4)),  BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT4)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC3,DAT4)), BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT4)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC3,DAT4)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC3,DAT4)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC3,DAT5)),  BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT5)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC3,DAT5)), BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT5)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC3,DAT5)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC3,DAT5)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC3,DAT6)),  BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT6)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC3,DAT6)), BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT6)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC3,DAT6)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC3,DAT6)),	BV_GPIO_MSDC_MODE);
			
			MSDC_SET_FIELD(GPIO_PULLEN_PIN2REG(PIN4_DAT(MSDC3,DAT7)),  BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT7)),      1);
			MSDC_SET_FIELD(GPIO_PULLSEL_PIN2REG(PIN4_DAT(MSDC3,DAT7)), BIT_GPIOMASK(PIN4_DAT(MSDC3,DAT7)),      1);
			MSDC_SET_FIELD(GPIO_MODE_PIN2REG(PIN4_DAT(MSDC3,DAT7)),    BIT_MODE_GPIOMASK(PIN4_DAT(MSDC3,DAT7)),	BV_GPIO_MSDC_MODE);
            break;
        default:
            MSDC_ERR_PRINT(MSDC_ERROR,("error...msdc_set_pad_init out of range!!\n"));
            break;
    }
}
#else
...
int msdc_init(int id, struct mmc_host *host, int clksrc, int mode)
{
    ...
    MSDC_ASSERT(((id < 3) && (clksrc < MSDC30_CLKSRC_MAX)) || ((id == 3) && (clksrc < MSDC50_CLKSRC_MAX)));
...
#ifndef FPGA_PLATFORM
    host->f_max  = (host->id == 3) ? hclks_msdc50[clksrc] : hclks_msdc30[clksrc];
#else
...
#error   make sure undefined anyone MSDC_USE_FORCE_FLUSH MSDC_USE_RELIABLE_WRITE MSDC_USE_DATA_TAG MSDC_USE_PACKED_CMD
		...
		msdc_set_smt(host,1);
		/* set clk, cmd, dat pad driving */
		//msdc_set_driving(host, msdc_cap[host->id].clk_drv, msdc_cap[host->id].cmd_drv, msdc_cap[host->id].dat_drv);
		...
		msdc_config_clksrc(host, clksrc, hclksrc);
