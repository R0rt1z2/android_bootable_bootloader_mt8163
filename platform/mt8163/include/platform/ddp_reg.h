...
#define DDP_REG_BASE_MMSYS_CONFIG3 DISP_TOPCKGEN_BASE //0xf0000000
...
#define DDP_REG_BASE_DPI0          DPI0_BASE          //0xf401D000
#define DDP_REG_BASE_DPI1          0          
...
#define DDP_REG_BASE_DISP_OD      0      //0xf4023000
#define DDP_REG_BASE_DISP_CCORR      CCORR_BASE      //0xf4023000
#define DDP_REG_LVDS_TX				LVDS_TX_BASE   //0x14016200
#define DDP_REG_LVDS_ANA			LVDS_ANA_BASE  //0x10215800
...
// -------------------------------------------------------------
// DPI
#define DISP_REG_DPI_EN								(DISPSYS_DPI0_BASE + 0x000)
#define DISP_REG_DPI_RST								(DISPSYS_DPI0_BASE + 0x004)
#define DISP_REG_DPI_INTEN								(DISPSYS_DPI0_BASE + 0x008)
#define DISP_REG_DPI_INSTA								(DISPSYS_DPI0_BASE + 0x00C)
#define DISP_REG_DPI_CON								(DISPSYS_DPI0_BASE + 0x010)
#define DISP_REG_DPI_OUTPUT_SETTING					(DISPSYS_DPI0_BASE + 0x014)
#define DISP_REG_DPI_SIZE								(DISPSYS_DPI0_BASE + 0x018)
#define DISP_REG_DPI_DDR_SETTING						(DISPSYS_DPI0_BASE + 0x01c)
#define DISP_REG_DPI_TGEN_HWIDTH						(DISPSYS_DPI0_BASE + 0x020)
#define DISP_REG_DPI_TGEN_HPORCH						(DISPSYS_DPI0_BASE + 0x024)
#define DISP_REG_DPI_TGEN_VWIDTH						(DISPSYS_DPI0_BASE + 0x028)
#define DISP_REG_DPI_TGEN_VPORCH						(DISPSYS_DPI0_BASE + 0x02C)
#define DISP_REG_DPI_BG_HCNTL							(DISPSYS_DPI0_BASE + 0x030)
#define DISP_REG_DPI_BG_VCNTL							(DISPSYS_DPI0_BASE + 0x034)
#define DISP_REG_DPI_BG_COLOR							(DISPSYS_DPI0_BASE + 0x038)
#define DISP_REG_DPI_FIFO_CTL							(DISPSYS_DPI0_BASE + 0x03C)
#define DISP_REG_DPI_STATUS							(DISPSYS_DPI0_BASE + 0x040)
#define DISP_REG_DPI_TMODE								(DISPSYS_DPI0_BASE + 0x044)
#define DISP_REG_DPI_CHKSUM							(DISPSYS_DPI0_BASE + 0x048)
#define DISP_REG_DPI_PATTERN							(DISPSYS_DPI0_BASE + 0x04C)
#define DISP_REG_DPI_DUMMY							(DISPSYS_DPI0_BASE + 0x050)
#define DISP_REG_DPI_TGEN_VWIDTH_LEVEN				(DISPSYS_DPI0_BASE + 0x068)
#define DISP_REG_DPI_TGEN_VPORCH_LEVEN				(DISPSYS_DPI0_BASE + 0x06c)
#define DISP_REG_DPI_TGEN_VWIDTH_RODD				(DISPSYS_DPI0_BASE + 0x070)
#define DISP_REG_DPI_TGEN_VPORCH_RODD				(DISPSYS_DPI0_BASE + 0x074)
#define DISP_REG_DPI_TGEN_VWIDTH_REVEN				(DISPSYS_DPI0_BASE + 0x078)
#define DISP_REG_DPI_TGEN_VPORCH_REVEN				(DISPSYS_DPI0_BASE + 0x07c)
#define DISP_REG_DPI_ESAV_VTIM_L						(DISPSYS_DPI0_BASE + 0x080)
#define DISP_REG_DPI_ESAV_VTIM_R						(DISPSYS_DPI0_BASE + 0x084)
#define DISP_REG_DPI_ESAV_VTIM_R						(DISPSYS_DPI0_BASE + 0x088)
#define DISP_REG_DPI_CLPF_SETTING						(DISPSYS_DPI0_BASE + 0x08c)
#define DISP_REG_DPI_Y_LIMIT							(DISPSYS_DPI0_BASE + 0x090)
#define DISP_REG_DPI_C_LIMIT							(DISPSYS_DPI0_BASE + 0x094)
#define DISP_REG_DPI_YUV422_SETTING					(DISPSYS_DPI0_BASE + 0x098)
#define DISP_REG_DPI_EMBSYNC_SETTING					(DISPSYS_DPI0_BASE + 0x09c)
#define DISP_REG_DPI_ESAV_CODE_SET0					(DISPSYS_DPI0_BASE + 0x0a0)
#define DISP_REG_DPI_ESAV_CODE_SET1					(DISPSYS_DPI0_BASE + 0x0a4)
...
#define MMSYS_CG_FLD_CG1_DPI_PIX                               REG_FLD(1, 5) 
#define MMSYS_CG_FLD_CG1_DPI_ENG                               REG_FLD(1, 4)
#define MMSYS_CG_FLD_CG1_LVDS_PIX                               REG_FLD(1, 6)
#define MMSYS_CG_FLD_CG1_LVDS_CTS                               REG_FLD(1, 7)
