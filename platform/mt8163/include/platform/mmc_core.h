...
struct mmc_host
{
    ...
    u8  pll_mux_hclk;  /* the mux of system pll clock */
...
extern int mmc_init(u32 id, u32 trans_mode);
...
extern int mmc_legacy_init(u32 verbose);
extern u32 mmc_whoami(void);
extern int mmc_emmc_boot_prepare(void);
#ifdef __cplusplus
}
#endif
