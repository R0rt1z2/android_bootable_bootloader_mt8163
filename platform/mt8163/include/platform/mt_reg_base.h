...
#define LVDS_ANA_BASE (0x10215800)
#define LVDS_TX_BASE (0x1401B200)
...
//#define USB3_BASE (0x11270000) /* fixme: can't find in mt8163 */

// APB Module ssusb_top_sif
//#define USB3_SIF_BASE (0x11280000) /* fixme: can't find in mt8163 */

// APB Module ssusb_top_sif2
//#define USB3_SIF2_BASE (0x11290000) /* fixme: can't find in mt8163 */
...
#else
#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT3,921600n1 console=ttyS0,921600n1 earlycon=uart8250,mmio32,0x11002000 root=/dev/ram vmalloc=496M androidboot.hardware=mt8163"
#endif
