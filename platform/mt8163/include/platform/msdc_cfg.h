...
/* don't modify these definition below */
#ifdef MSDC_ENABLE_DMA_MODE
...
#if (!(defined(MSDC_MODE_DEFAULT_DMA_BASIC) || defined(MSDC_MODE_DEFAULT_DMA_DESC) || defined(MSDC_MODE_DEFAULT_DMA_ENHANCED)))
#error Please define MSDC_MODE_DEFAULT_DMA_BASIC/MSDC_MODE_DEFAULT_DMA_DESC/MSDC_MODE_DEFAULT_DMA_ENHANCED first
#endif

#endif

#if (!(defined(MSDC_MODE_DEFAULT_PIO) || defined(MSDC_ENABLE_DMA_MODE)))
#error Please define MSDC_MODE_DEFAULT_PIO/MSDC_ENABLE_DMA_MODE first
#endif
...
#endif
#endif
/* K2 must define, but fpga bitfile only 16bit, no define in early porting*/
#define MSDC_GPD_BD_BUF_LEN_24BIT
